	...
	<div class="wrapper">
						...
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<?php if ($this->auth->getProfileid() == 1) { ?>
									<?php echo $this->tag->image(array('img/Logo_azul_cyc.png', 'class' => 'user-image', 'alt' => 'User Image')); ?>
								<?php } else { ?>
									<?php echo $this->tag->image(array('img/Bid_vertical.png', 'class' => 'user-image', 'alt' => 'User Image')); ?>
								<?php } ?>
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									<?php if ($this->auth->getProfileid() == 1) { ?>
										<?php echo $this->tag->image(array('img/Logo_azul_cyc.png', 'class' => 'img-circle', 'alt' => 'User Image')); ?>
									<?php } else { ?>
										<?php echo $this->tag->image(array('img/Bid_vertical.png', 'class' => 'img-circle', 'alt' => 'User Image')); ?>
									<?php } ?>
									<p>
										<?php echo $this->auth->getName(); ?>
                    <small>Última modificación <?php echo $this->auth->getLastIng(); ?></small>
									</p>
								</li>
								<!-- Menu Footer-->
		...
		<?php if ($this->auth->getProfileid() == 1) { ?>
            ...
            <li><a href="/bidcan/reset"><i class="active fa fa-edit"></i> <span>Eliminar Registro</span></a></li>
						...
						<li><a><i class="fa fa-circle-o text-red"></i><span>Encuestas registradas :</span><small class="label pull-right bg-red"><?php echo $cntBid; ?></small></a></li>
						<li><a><i class="fa fa-circle-o text-aqua"></i><span>Encuestas x registrar :</span><small class="label pull-right bg-aqua"><?php echo $paisesTotal - $cntBid; ?></small></a></li>
