	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2" class="page-header">
			<div class="box box-warning">
				<div class="box-body">
					<?php echo $this->tag->form(array('id' => 'reset', 'name' => 'reset', 'bidcan/reset', 'method' => 'post')); ?>
		          ...
		          <?php echo $this->tag->submitButton(array('Eliminar registro', 'id' => 'save', 'name' => 'save', 'class' => 'btn btn-primary')); ?>
		        </div>
					</form>
				</div>
			</div>
