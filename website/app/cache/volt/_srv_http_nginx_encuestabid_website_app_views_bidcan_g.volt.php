...
<section class="content">
	...
	<div class="row">
		...
		<input type="hidden" name="prg_g_1" value=<?php echo $g_1; ?>>
		<input type="hidden" name="prg_g_2_txt" value=<?php echo $g_2_txt; ?>>
		<input type="hidden" name="prg_g_3" value=<?php echo $g_3; ?>>
		<input type="hidden" name="prg_g_4_a" value=<?php echo $g_4_a; ?>>
		<input type="hidden" name="prg_g_4_b" value=<?php echo $g_4_b; ?>>
		<input type="hidden" name="prg_g_4_c" value=<?php echo $g_4_c; ?>>
		<input type="hidden" name="prg_g_5_txt" value=<?php echo $g_5_txt; ?>>
		<input type="hidden" name="prg_g_6" value=<?php echo $g_6; ?>>
		<input type="hidden" name="prg_g_7" value=<?php echo $g_7; ?>>
		<input type="hidden" name="prg_g_8" value=<?php echo $g_8; ?>>
		<input type="hidden" name="prg_g_9" value=<?php echo $g_9; ?>>
		<input type="hidden" name="prg_g_10" value=<?php echo $g_10; ?>>

			<?php echo $this->tag->form(array('id' => 'g', 'name' => 'g', 'bidcan/g', 'method' => 'post')); ?>
						...
						<div class="box-body">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_1_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_1_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_3_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_3_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_4_a_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_a_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_a_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_a_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_a_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_a_6'); ?><p>6</p>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_4_b_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_b_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_b_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_b_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_b_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_b_6'); ?><p>6</p>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_4_c_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_c_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_c_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_c_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_c_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_4_c_6'); ?><p>6</p>
									</label>
								</div>
							</div>
							</br>
							...
							<?php if ($this->auth->getPais() == 'Front Office') { ?>
							<div class="form-group">
								 <label class="col-xs-12" style="text-align:justify">42. ¿Qué sugerencias tendría para mejorar el Plan de Trabajo del Front Office de CAN de manera que los objetivos fueran más claros, específicos o compartidos por más miembros de la COF?</label>
							</div>
							<?php } else { ?>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_6_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_6_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_7_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_7_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_8_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_8_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_9_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_9_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('g_10_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_7'); ?><p>No sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('g_10_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							<?php } ?>
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          <?php echo $this->tag->linkTo(array('bidcan/f', 'Anterior', 'class' => 'btn btn-primary')); ?>
        </div>
