...
<section class="content">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="hidden" name="prg_area_2_1" value=<?php echo $area_2_1; ?>>
			<input type="hidden" name="prg_area_2_2" value=<?php echo $area_2_2; ?>>
			<input type="hidden" name="prg_area_2_3" value=<?php echo $area_2_3; ?>>
			<input type="hidden" name="prg_area_2_4" value=<?php echo $area_2_4; ?>>
			<input type="hidden" name="prg_area_2_5" value=<?php echo $area_2_5; ?>>

			<?php echo $this->tag->form(array('id' => 'area2', 'name' => 'area2', 'bidcan/area2', 'method' => 'post')); ?>
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          <?php echo $this->tag->linkTo(array('bidcan/area1', 'Anterior', 'class' => 'btn btn-primary')); ?>
        </div>
