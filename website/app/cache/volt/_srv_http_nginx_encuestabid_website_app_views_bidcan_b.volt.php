...
<section class="content">
	...
	<div class="row">
		...
		<input type="hidden" name="prg_b_1" value=<?php echo $b_1; ?>>
		<input type="hidden" name="prg_b_2" value=<?php echo $b_2; ?>>
		<input type="hidden" name="prg_b_3" value=<?php echo $b_3; ?>>
		<input type="hidden" name="prg_b_4" value=<?php echo $b_4; ?>>
		<input type="hidden" name="prg_b_5_a" value=<?php echo $b_5_a; ?>>
		<input type="hidden" name="prg_b_5_b" value=<?php echo $b_5_b; ?>>
		<input type="hidden" name="prg_b_5_c" value=<?php echo $b_5_c; ?>>
		<input type="hidden" name="prg_b_6" value=<?php echo $b_6; ?>>
		<input type="hidden" name="prg_b_7" value=<?php echo $b_7; ?>>
		<input type="hidden" name="prg_b_8_txt" value=<?php echo $b_8_txt; ?>>
		<input type="hidden" name="prg_b_9" value=<?php echo $b_9; ?>>
		<input type="hidden" name="prg_b_10" value=<?php echo $b_10; ?>>

			<?php echo $this->tag->form(array('id' => 'b', 'name' => 'b', 'bidcan/b', 'method' => 'post')); ?>
						...
						<div class="box-body">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_1_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_1_8'); ?><p>No Responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_2_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_2_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_3_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_3_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_4_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_4_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_5_a_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_a_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_5_b_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_b_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_5_c_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_5_c_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_6_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_6_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_7_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_7_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
					...
					<div class="box box-warning">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_9_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_9_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="btn-group col-md-offset-2 col-xs-offset-1" data-toggle="buttons">
									<label class="btn">
										<?php echo $form->render('b_10_1'); ?><p>1</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_2'); ?><p>2</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_3'); ?><p>3</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_4'); ?><p>4</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_5'); ?><p>5</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_6'); ?><p>6</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_7'); ?><p>No Sabe</p>
									</label>
									<label class="btn">
										<?php echo $form->render('b_10_8'); ?><p>No responde</p>
									</label>
								</div>
							</div>
							</br>
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          <?php echo $this->tag->linkTo(array('bidcan/a', 'Anterior', 'class' => 'btn btn-primary')); ?>
        </div>
