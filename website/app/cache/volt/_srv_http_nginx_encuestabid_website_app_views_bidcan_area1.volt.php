...
<section class="content">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="hidden" name="prg_area_1_1" value=<?php echo $area_1_1; ?>>
			<input type="hidden" name="prg_area_1_2" value=<?php echo $area_1_2; ?>>
			<input type="hidden" name="prg_area_1_3" value=<?php echo $area_1_3; ?>>
			<input type="hidden" name="prg_area_1_4" value=<?php echo $area_1_4; ?>>
			<input type="hidden" name="prg_area_1_5" value=<?php echo $area_1_5; ?>>

			<?php echo $this->tag->form(array('id' => 'area1', 'name' => 'area1', 'bidcan/area1', 'method' => 'post')); ?>
