...
<section class="content">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="hidden" name="prg_o_1" value=<?php echo $o_1; ?>>
			<input type="hidden" name="prg_o_2" value=<?php echo $o_2; ?>>
			<input type="hidden" name="prg_o_3" value=<?php echo $o_3; ?>>

			<?php echo $this->tag->form(array('id' => 'o', 'name' => 'o', 'bidcan/o', 'method' => 'post')); ?>
					...
					<div class="box box-success">
						<div class="box-body">
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<label class="radio-inline">
										<?php echo $form->render('o_1_1'); ?><p>Si</p>
									</label>
									<label class="radio-inline">
										<?php echo $form->render('o_1_2'); ?><p>No</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<label class="radio-inline">
										<?php echo $form->render('o_2_1'); ?><p>Si</p>
									</label>
									<label class="radio-inline">
										<?php echo $form->render('o_2_2'); ?><p>No</p>
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<label class="radio-inline">
										<?php echo $form->render('o_3_1'); ?><p>Si</p>
									</label>
									<label class="radio-inline">
										<?php echo $form->render('o_3_2'); ?><p>No</p>
									</label>
								</div>
							</div>
							</br>
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          <?php echo $this->tag->linkTo(array('bidcan/n', 'Anterior', 'class' => 'btn btn-primary')); ?>
        </div>
