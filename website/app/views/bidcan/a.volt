...
<section class="content">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="hidden" name="prg_a_1" value={{ a_1 }}>
			<input type="hidden" name="prg_a_2" value={{ a_2 }}>
			<input type="hidden" name="prg_a_3" value={{ a_3 }}>
			<input type="hidden" name="prg_a_4" value={{ a_4 }}>
			<input type="hidden" name="prg_a_5" value={{ a_5 }}>

			{{ form('id':'a', 'name':'a', 'bidcan/a', 'method':'post') }}
		            ...
		            <hr>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<label class="radio">
										{{ form.render("a_1_1") }}&nbsp;&nbsp;Masculino
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_1_2") }}&nbsp;&nbsp;Femenino
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<br>
									<label class="radio">
										{{ form.render("a_2_1") }}&nbsp;&nbsp;Menos de 1 año
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_2_2") }}&nbsp;&nbsp;Entre 1 y 5 años
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_2_3") }}&nbsp;&nbsp;Más de 5 años
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<br>
									<label class="radio">
										{{ form.render("a_3_1") }}&nbsp;&nbsp;Menos de 1 año
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_3_2") }}&nbsp;&nbsp;Entre 1 y 5 años
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_3_3") }}&nbsp;&nbsp;Más de 5 años
									</label>
								</div>
							</div>
							</br>
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<br>
									<label class="radio">
										{{ form.render("a_4_1") }}&nbsp;&nbsp;Gerente general
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_2") }}&nbsp;&nbsp;Operativo
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_3") }}&nbsp;&nbsp;Economistas
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_4") }}&nbsp;&nbsp;Performance
									</label>
								</div>
							</div>
							{% else %}
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<br>
									<label class="radio">
										{{ form.render("a_4_1") }}&nbsp;&nbsp;Especialista
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_2") }}&nbsp;&nbsp;Analista de operaciones
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_3") }}&nbsp;&nbsp;Administrativo
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_4") }}&nbsp;&nbsp;Gerencial
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_4_5") }}&nbsp;&nbsp;Otro
									</label>
								</div>
							</div>
							{% endif %}
							...
							<div class="form-group">
								<div class="radio col-xs-offset-3">
									<br>
									<label class="radio">
										{{ form.render("a_5_1") }}&nbsp;&nbsp;Staff del banco
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_5_2") }}&nbsp;&nbsp;Consultor o tercerizado
									</label>
									<br>
									<label class="radio">
										{{ form.render("a_5_3") }}&nbsp;&nbsp;Tercerizado
									</label>
								</div>
							</div>
							</br>
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          {{ link_to("bidcan/index", "Anterior", "class": "btn btn-primary") }}
        </div>
