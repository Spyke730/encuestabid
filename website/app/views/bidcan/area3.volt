...
<section class="content">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<input type="hidden" name="prg_area_3_1" value={{ area_3_1 }}>
			<input type="hidden" name="prg_area_3_2" value={{ area_3_2 }}>
			<input type="hidden" name="prg_area_3_3" value={{ area_3_3 }}>
			<input type="hidden" name="prg_area_3_4" value={{ area_3_4 }}>
			<input type="hidden" name="prg_area_3_5" value={{ area_3_5 }}>

			{{ form('id':'area3', 'name':'area3', 'bidcan/area3', 'method':'post') }}
      ...
      <div class="row">
        <div class="col-sm-6 col-xs-6" align="left">
          {{ link_to("bidcan/area2", "Anterior", "class": "btn btn-primary") }}
        </div>
